...
local LANGS = {
    ['zh'] = {
        ...
        config = {
            ...
            { modid .. '_center_water', '中心水域', '', false, {
                { "禁用", false, "實心地面，可以放冰眼結晶器或避雷針" },
                { "1x1", 0, "中心1x1水域，可以釣魚？" },
                { "3x3", 1, "中心3x3水域，可以種植水中木" },
            } },
            { modid .. '_center_entity', '中心實體', '', false, {
                { "禁用", false },
            ...
            { modid .. '_oceanvine', '水中木無花果藤條位置', '需要在中心實體中選擇原生水中木或移植水中木', false, {
                { "禁用", false, "無苔癬藤條" },
                { "上下左右各1條", "cross", "距離中心4格地皮" },
                { "四角方位各1條", "square", "距離中心4格地皮" },
            } },
        }
    },
    ['en'] = {
