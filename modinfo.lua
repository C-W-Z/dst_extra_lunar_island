...
local LANGS = {
    ['zh'] = {
        ...
        config = {
            ...
            { modid .. '_size', '大小', '單位是地皮', 19, {
                { "19x19", 19 },
                { "33x33", 33 },
            } },
            { modid .. '_beach', '外圍沙灘', '將外圍換成岩石海灘地皮', true, {
                { "禁用", false },
                { "啟用", true },
            } },
            ...
            { modid .. '_center_entity', '中心實體', '在圓心生成一個實體', false, {
                { "禁用", false },
                { "溫泉", "hotspring", "建議禁用中心水域" },
                { "綠洲湖泊", "oasislake", "建議禁用中心水域，沙漠綠洲不受影響" },
                { "原生的水中木", "watertree_pillar", "大樹幹" },
                { "移植的水中木", "oceantree_pillar", "高出平均值的樹幹" },
            } },
            ...
            { modid .. '_oceanvine_distance', '無花果藤條與中心距離', '需要啟用"水中木無花果藤條位置"才會生效', 2, {
                ...
                { "4.5", 4.5, "位置選擇四角的話會超出庇蔭範圍，可配合擴大水中木範圍的模組使用" },
                { "5", 5, "會超出庇蔭範圍，可配合擴大水中木範圍的模組使用" },
                { "5.5", 5.5, "會超出庇蔭範圍，可配合擴大水中木範圍的模組使用" },
                { "6", 6, "會超出庇蔭範圍，可配合擴大水中木範圍的模組使用" },
            } },
            { modid .. '_starfish', '海星數量', '每座額外月島最多生成幾個海星', 0, {
                { "禁用", 0 }, { "5個", 5 }, { "10個", 10 }, { "15個", 15 }, { "20個", 20 }, { "25個", 25 }, { "30個", 30 }, { "40個", 40 }, { "50個", 50 }, { "75個", 75 }, { "100個", 100 },
            } },
            { modid .. '_kelp', '海帶根數量', '每座額外月島最多生成幾個公牛海帶根', 0, {
                { "禁用", 0 }, { "5個", 5 }, { "10個", 10 }, { "15個", 15 }, { "20個", 20 }, { "25個", 25 }, { "30個", 30 },
            } },
            { modid .. '_bones', '海骨數量', '每座額外月島最多生成幾個海骨', 0, {
                { "禁用", 0 }, { "5個", 5 }, { "10個", 10 }, { "15個", 15 }, { "20個", 20 }, { "25個", 25 }, { "30個", 30 },
            } },
            { modid .. '_driftwood', '浮木數量', '每座額外月島最多生成幾個浮木', 0, {
                { "禁用", 0 }, { "5個", 5 }, { "10個", 10 }, { "15個", 15 }, { "20個", 20 }, { "25個", 25 }, { "30個", 30 },
            } },
            { modid .. '_lunatree', '月樹數量', '每座額外月島最多生成幾棵月樹', 0, {
                { "禁用", 0 }, { "5個", 5 }, { "10個", 10 }, { "15個", 15 }, { "20個", 20 }, { "25個", 25 }, { "30個", 30 },
            } },
            { modid .. '_sapling', '樹苗數量', '每座額外月島最多生成幾個樹苗', 0, {
                { "禁用", 0 }, { "5個", 5 }, { "10個", 10 }, { "15個", 15 }, { "20個", 20 }, { "25個", 25 }, { "30個", 30 },
            } },
            { modid .. '_stonefruit', '石果數量', '每座額外月島最多生成幾個石果灌木叢', 0, {
                { "禁用", 0 }, { "5個", 5 }, { "10個", 10 }, { "15個", 15 }, { "20個", 20 }, { "25個", 25 }, { "30個", 30 },
            } },
            { modid .. '_moonglass', '月光玻璃數量', '每座額外月島最多生成幾個月光玻璃礦', 0, {
                { "禁用", 0 }, { "5個", 5 }, { "10個", 10 }, { "15個", 15 }, { "20個", 20 }, { "25個", 25 }, { "30個", 30 },
            } },
            { modid .. '_moonrock', '月岩數量', '每座額外月島最多生成幾個月岩', 0, {
                { "禁用", 0 }, { "5個", 5 }, { "10個", 10 }, { "15個", 15 }, { "20個", 20 }, { "25個", 25 }, { "30個", 30 },
            } },
        }
    },
